...
//
// $Id: MathBaseUtil.h 5607 2012-02-22 15:08:05Z shun $
//
...
const CMatrix<nNumCols, nNumRows, T> pseudo_inverse_of(const CMatrix<nNumRows, nNumCols, T>& mat)
{
...
const CDynamicMatrix<T> pseudo_inverse_of(const CDynamicMatrix<T>& mat)
{
